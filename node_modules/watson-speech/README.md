...
[Python](https://github.com/watson-developer-cloud/python-sdk/blob/v0.31.0/examples/authorization_v1.py), 
...
The basic API is outlined below, see complete API docs at http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/

See code for several basic examples at https://github.com/watson-developer-cloud/speech-javascript-sdk/tree/v0.31.0/examples/static/
...
(See https://github.com/watson-developer-cloud/speech-javascript-sdk/tree/v0.31.0/examples/ for a couple of basic examples in Node.js and Python.)

## [`WatsonSpeech.TextToSpeech`](http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/module-watson-speech_text-to-speech.html)

### [`.synthesize({text, token})`](http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/module-watson-speech_text-to-speech_synthesize.html) -> `<audio>`
...
## [`WatsonSpeech.SpeechToText`](http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/module-watson-speech_speech-to-text.html)
...
### [`.recognizeFile({data, token})`](http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/module-watson-speech_speech-to-text_recognize-file.html) -> Stream
...
* Removed `SpeechToText.recognizeElement()` due to quality issues. The code is [avaliable in an (unsupported) example](https://github.com/watson-developer-cloud/speech-javascript-sdk/tree/v0.31.0/examples/static/audio-video-deprecated) if you wish to use it with current releases of the SDK.
...
[RecognizeStream]: http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/RecognizeStream.html
[TimingStream]: http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/TimingStream.html
[FormatStream]: http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/FormatStream.html
[WritableElementStream]: http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/WritableElementStream.html
[SpeakerStream]: http://watson-developer-cloud.github.io/speech-javascript-sdk/v0.31.0/SpeakerStream.html
